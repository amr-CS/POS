...
{
    public class dbFinancialYear: IdbFinancialYear
    {
        ...
        public dbFinancialYear(clsADO clsADO)
        {
            _clsADO = clsADO;
        }


        public string funFinancialYearGET(
        ...
        int? pQueryTypeId = null)
        {
            ...
            vlstParam.Add(new SqlParameter("FinancialYear", pFinancialYear));
            vlstParam.Add(new SqlParameter("FinancialYearStart", pFinancialYearStart));
            vlstParam.Add(new SqlParameter("FinancialYearEnd", pFinancialYearEnd));
            vlstParam.Add(new SqlParameter("FinancialYearStatusId", pFinancialYearStatusId));
            vlstParam.Add(new SqlParameter("BranchId", clsCompany.vBranchId));
            vlstParam.Add(new SqlParameter("FinancialYearIsActive", pFinancialYearIsActive));
            ...
            vData = _clsADO.funExecuteScalar("ACC.spFinancialYearCRUD", vlstParam, "Data GET").ToString();
            return vData;
        }
        public DataTable funGetFinancialYearReport(bool? pIsActive = null)
        {
            // Declaration 
            DataTable vData;
            // Parameters
            ...
            vData = _clsADO.funFillDataTable("ACC.spFinancialYearReport", vlstParam, "Data GET");
