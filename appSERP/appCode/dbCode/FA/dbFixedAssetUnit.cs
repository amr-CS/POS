...
{
    public class dbFixedAssetUnit : IdbFixedAssetUnit
    {
        // Message
        ...
        public dbFixedAssetUnit(clsADO clsADO)
        {
            _clsADO = clsADO;
        }

        public string funFixedAssetUnitGET(
        ...
        int? pQueryTypeId = null)
        {
            ...
            vlstParam.Add(new SqlParameter("FixedAssetUnitNameL1", pFixedAssetUnitNameL1));
            vlstParam.Add(new SqlParameter("FixedAssetUnitNameL2", pFixedAssetUnitNameL2));
            vlstParam.Add(new SqlParameter("FixedAssetUnitIsActive", pFixedAssetUnitIsActive));
            ...
            vData = _clsADO.funExecuteScalar("FA.spFixedAssetUnitCRUD", vlstParam, "Data GET").ToString();
            return vData;
        }
        public DataTable funGetFixedAssetUnitReport(bool? pIsActive = null)
        {
            // Declaration 
            DataTable vData;
            // Parameters
            ...
            vData = _clsADO.funFillDataTable("FA.spFixedAssetUnitReport", vlstParam, "Data GET");
