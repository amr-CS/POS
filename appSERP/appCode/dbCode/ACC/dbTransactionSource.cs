...
{
    public class dbTransactionSource : IdbTransactionSource
    {
        // Message
        ...
        public dbTransactionSource(clsADO clsADO)
        {
            _clsADO = clsADO;
        }


        public string funTransactionSourceGET(
        ...
        int? pQueryTypeId = null)
        {
            ...
            vlstParam.Add(new SqlParameter("TransactionSourceId", pTransactionSourceId));
            vlstParam.Add(new SqlParameter("TransactionSourceCode", pTransactionSourceCode));
            vlstParam.Add(new SqlParameter("TransactionSourceNameL1", pTransactionSourceNameL1));
            vlstParam.Add(new SqlParameter("TransactionSourceNameL2", pTransactionSourceNameL2));
            vlstParam.Add(new SqlParameter("TransactionSourceIsActive", pTransactionSourceIsActive));
            ...
            vData = _clsADO.funExecuteScalar("ACC.spTransactionSourceCRUD", vlstParam, "Data GET").ToString();
            return vData;
        }
        public DataTable funGetTransactionSourceReport(bool? pIsActive = null)
        {
            // Declaration 
            DataTable vData;
            // Parameters
            ...
            vData = _clsADO.funFillDataTable("ACC.spTransactionSourceReport", vlstParam, "Data GET");
