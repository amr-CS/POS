...
{
    public class dbAssetUnDep: IdbAssetUnDep
    {
        // Message
        ...
        public dbAssetUnDep(clsADO clsADO)
        {
            _clsADO = clsADO;
        }

        public string funAssetUnDepGET(
        ...
        int? pQueryTypeId = null)
        {
            ...
            vlstParam.Add(new SqlParameter("AssetUnDepId", pAssetUnDepId));
            ...
            vlstParam.Add(new SqlParameter("AssetUnDepDate", pAssetUnDepDate));
            vlstParam.Add(new SqlParameter("AssetUnDepIsActive", pAssetUnDepIsActive));
            ...
            vData = _clsADO.funExecuteScalar("FA.spAssetUnDepCRUD", vlstParam, "Data GET").ToString();
            return vData;
        }
        public DataTable funGetAssetUnDepReport(bool? pIsActive = null)
        {
            // Declaration 
            DataTable vData;
            // Parameters
            ...
            vData = _clsADO.funFillDataTable("FA.spAssetUnDepReport", vlstParam, "Data GET");
