...
{
    public class dbFixedAssetSite : IdbFixedAssetSite
    {
        // Message
        ...
        public dbFixedAssetSite(clsADO clsADO)
        {
            _clsADO = clsADO;
        }

        public string funFixedAssetSiteGET(
        ...
        int? pQueryTypeId = null)
        {
            ...
            vlstParam.Add(new SqlParameter("FixedAssetSiteId", pFixedAssetSiteId));
            vlstParam.Add(new SqlParameter("FixedAssetSiteQty", pFixedAssetSiteQty));
            vlstParam.Add(new SqlParameter("FixedAssetSiteTransDate", pFixedAssetSiteTransDate));
            ...
            vlstParam.Add(new SqlParameter("FixedAssetSiteIsActive", pFixedAssetSiteIsActive));
            ...
            vData = _clsADO.funExecuteScalar("FA.spFixedAssetSiteCRUD", vlstParam, "Data GET").ToString();
            return vData;
        }
        public DataTable funGetFixedAssetSiteReport(bool? pIsActive = null)
        {
            // Declaration 
            DataTable vData;
            // Parameters
            ...
            vData = _clsADO.funFillDataTable("FA.spFixedAssetSiteReport", vlstParam, "Data GET");
