...
{
    public class dbStoreDepartment : IdbStoreDepartment
    {
        public string vSQLResult { get; set; }
        public int vSQLResultTypeId { get; set; }

        private IclsADO _clsADO;
        public dbStoreDepartment(clsADO clsADO)
        {
            _clsADO = clsADO;
        }

        public string funStoreDepartmentGET(
        ...
        int? pQueryTypeId = null)
        {
            ...
            vlstParam.Add(new SqlParameter("StoreDepartmentId", pStoreDepartmentId));
            vlstParam.Add(new SqlParameter("StoreDepartmentCode", pStoreDepartmentCode));
            vlstParam.Add(new SqlParameter("StoreDepartmentNameL1", pStoreDepartmentNameL1));
            vlstParam.Add(new SqlParameter("StoreDepartmentNameL2", pStoreDepartmentNameL2));
            vlstParam.Add(new SqlParameter("StoreDepartmentIsActive", pStoreDepartmentIsActive));
            ...
            vData = _clsADO.funExecuteScalar("INV.spStoreDepartmentCRUD", vlstParam, "Data GET").ToString();
            return vData;
        }

        public DataTable funGetStoreDepartmentReport(bool? pIsActive = null)
        {
            // Declaration 
            DataTable vData;
            // Parameters
            ...
            vData = _clsADO.funFillDataTable("INV.spStoreDepartmentReport", vlstParam, "Data GET");
