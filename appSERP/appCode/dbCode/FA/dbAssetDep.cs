...
{
    public class dbAssetDep: IdbAssetDep
    {
        // Message
        ...
        public dbAssetDep(clsADO clsADO)
        {
            _clsADO = clsADO;
        }

        public string funAssetDepGET(
        ...
        int? pQueryTypeId = null)
        {
            ...
            vlstParam.Add(new SqlParameter("AssetDepId", pAssetDepId));
            ...
            vlstParam.Add(new SqlParameter("AssetDepDate", pAssetDepDate));
            vlstParam.Add(new SqlParameter("AssetDepIsActive", pAssetDepIsActive));
            ...
            vData = _clsADO.funExecuteScalar("FA.spAssetDepCRUD", vlstParam, "Data GET").ToString();
            return vData;
        }
        public DataTable funGetAssetDepReport(bool? pIsActive = null)
        {
            // Declaration 
            DataTable vData;
            // Parameters
            ...
            vData = _clsADO.funFillDataTable("FA.spAssetDepReport", vlstParam, "Data GET");
