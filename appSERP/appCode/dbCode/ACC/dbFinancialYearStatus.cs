...
{
    public class dbFinancialYearStatus : IdbFinancialYearStatus
    {
        public string vSQLResult { get; set; }
        public int vSQLResultTypeId { get; set; }

        private IclsADO _clsADO;
        public dbFinancialYearStatus(clsADO clsADO)
        {
            _clsADO = clsADO;
        }

        public string funFinancialYearStatusGET(
        ...
        int? pQueryTypeId = null)
        {
            ...
            vlstParam.Add(new SqlParameter("FinancialYearStatusNameL1", pFinancialYearStatusNameL1));
            vlstParam.Add(new SqlParameter("FinancialYearStatusNameL2", pFinancialYearStatusNameL2));
            vlstParam.Add(new SqlParameter("FinancialYearStatusIsActive", pFinancialYearStatusIsActive));
            ...
            vData = _clsADO.funExecuteScalar("ACC.spFinancialYearStatusCRUD", vlstParam, "Data GET").ToString();
            return vData;
        }
        public DataTable funGetFinancialYearStatusReport(bool? pIsActive = null)
        {
            // Declaration 
            DataTable vData;
            // Parameters
            ...
            vData = _clsADO.funFillDataTable("ACC.spFinancialYearStatusReport", vlstParam, "Data GET");
