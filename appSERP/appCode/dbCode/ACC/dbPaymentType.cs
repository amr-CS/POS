...
namespace appSERP.appCode.dbCode.ACC
{
    ...
    public class dbPaymentType : IdbPaymentType
    {
        public string vSQLResult { get; set; }
        public int vSQLResultTypeId { get; set; }

        private IclsADO _clsADO;
        public dbPaymentType(clsADO clsADO)
        {
            _clsADO = clsADO;
        }

        public string funPaymentTypeGET(
        ...
        int? pQueryTypeId = null)
        {
            ...
            vlstParam.Add(new SqlParameter("PaymentTypeCode", pPaymentTypeCode));
            vlstParam.Add(new SqlParameter("PaymentTypeNameL1", pPaymentTypeNameL1));
            vlstParam.Add(new SqlParameter("PaymentTypeNameL2", pPaymentTypeNameL2));
            vlstParam.Add(new SqlParameter("PaymentTypeIsActive", pPaymentTypeIsActive));
            ...
            vData = _clsADO.funExecuteScalar("ACC.spPaymentTypeCRUD", vlstParam, "Data GET").ToString();
            return vData;
        }
        public DataTable funGetPaymentTypeReport(bool? pIsActive = null)
        {
            // Declaration 
            DataTable vData;
            // Parameters
            ...
            vData = _clsADO.funFillDataTable("ACC.spPaymentTypeReport", vlstParam, "Data GET");
