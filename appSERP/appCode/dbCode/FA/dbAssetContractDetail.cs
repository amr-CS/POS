...
{
    public class dbAssetContractDetail : IdbAssetContractDetail
    {
        // Message
        ...
        public dbAssetContractDetail(clsADO clsADO)
        {
            _clsADO = clsADO;
        }

        public string funAssetContractDetailGET(
        ...
        int? pQueryTypeId = null)
        {
            ...
            vlstParam.Add(new SqlParameter("AssetContractDetailId", pAssetContractDetailId));
            vlstParam.Add(new SqlParameter("AssetContractDetailSeq", pAssetContractDetailSeq));
            vlstParam.Add(new SqlParameter("AssetContractDetailQty", pAssetContractDetailQty));
            vlstParam.Add(new SqlParameter("AssetContractId", pAssetContractId));
            vlstParam.Add(new SqlParameter("AssetId", pAssetId));
            vlstParam.Add(new SqlParameter("AssetContractDetailIsActive", pAssetContractDetailIsActive));
            ...
            vData = _clsADO.funExecuteScalar("FA.spAssetContractDetailCRUD", vlstParam, "Data GET").ToString();
            return vData;
        }
        public DataTable funGetAssetContractDetailReport(bool? pIsActive = null)
        {
            // Declaration 
            DataTable vData;
            // Parameters
            ...
            vData = _clsADO.funFillDataTable("FA.spAssetContractDetailReport", vlstParam, "Data GET");
