...
namespace appSERP.appCode.Setting.ReportSetting
{
    ...
    public class Demo : IDisposable
    {
        ...
        public Demo(IdbInvItem dbInvItem) {
        ...
        public  void Run()
        {
            ...
            string pReportName = "rptPOS";
            report.ReportPath = System.Web.Hosting.HostingEnvironment.MapPath(vReportMainFolder) + pReportName + vReportExtension;
