...
{
    public  class clsADO_ForHangFire
    {


            public   string connString= System.Configuration.ConfigurationManager.ConnectionStrings["dbERPConnectionString"].ConnectionString;
            private ILog _ILog;
            ...
            public DataTable funFillDataTable(string pCmdText, List<SqlParameter> pLstParam = null, string pFrmText = null)
            {
                try
                {
                    ...
                    using (var sqlConn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["dbERPConnectionString"].ConnectionString))
                    {
                        // Command
